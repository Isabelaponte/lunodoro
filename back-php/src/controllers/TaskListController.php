...
if (validatorMethodServer('POST')) {
    if (isset($_POST['nome']) && isset($_POST['id_lista']) && isset($_POST['id_tarefa'])){
        try {
...
if (validatorMethodServer('GET') && isset($_GET['id_usuario']) && isset($_GET['id_lista'])) {
    try {
...
if (validatorMethodServer('GET') && isset($_GET['id_tarefa']) && isset($_GET['id_usuario'])) {
    try {
